  ...
  return (
    <div className="flex px-10 justify-center">
      <div className="bg-white shadow-xl rounded-lg p-8 w-full max-w-4xl">
        ...
        <a href="/about">
        <h2 className="font-style: italic text-fedblue hover:text-honblue text-center text-lg"> Don&apos;t like Reading? Click to see About Me Video </h2>
        </a>
        <section className="mb-8">
          <p className="text-lg mt-4 text-fedblue">
